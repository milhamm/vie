      ...
      <div className="h-[220px] w-full bg-[black]">
        <div className="p-8 flex justify-between">
          <div>
            ...
            <h1 className="text-xl	 font-semibold text-[white]">Muhammad Memeng</h1>
            <h2 className="text-xs	text-[white] mt-1">kurniadiahmadwijaya@gmail.com</h2>
            ...
            <div className="mt-5">
              <Button colorScheme='main' size='xs'>Edit Profile</Button>
            </div>
          </div>
          <div>
            <Box boxSize='115px'>
              <Image src='https://bit.ly/dan-abramov' alt='Dan Abramov' borderRadius="8px" />
            </Box>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <div className="h-[140px] w-[420px] rounded-lg	bg-[green]">
          <div className="p-4">
            ...
            <h1 className="font-black	text-3xl	text-[white]">Gemastik XII - UX Design</h1>
      ...
      <div className="mt-5 flex justify-center">
        <div className="h-[140px] w-[420px] rounded-lg	bg-[purple]">
          <div className="p-4">
            ...
            <h1 className="font-black	text-3xl	text-[white]">Code 2020 - IT Business</h1>
